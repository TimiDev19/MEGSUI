...
const Roadmap = () => {
    return (
        <div
            id='roadmap'
            className=' w-[100vw] h-[100vh] pt-[100px] px-[10px] text-white mb-8'
        >
                ...
                <div id="how-to-buy" className=" w-full px-2 mb-6">
                    <div className=" border-l border-l-blue-500 h-fit">
                        ...
                        <div className=" mx-4 w-[90%] px-3 py-5 text-white bg-blue-600 rounded-md mb-6 roadmap-bg">
                        ...
                        <div className=" mx-4 w-[90%] px-3 py-5 text-white bg-blue-600 rounded-md mb-6 roadmap-bg1">
                        ...
                        <div className=" mx-4 w-[90%] px-3 py-5 text-white bg-blue-600 rounded-md mb-6 roadmap-bg2">
                        ...
                        <div className=" mx-4 w-[90%] px-3 py-5 text-white bg-blue-600 rounded-md mb-6 roadmap-bg3">
