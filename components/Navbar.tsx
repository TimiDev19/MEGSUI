            ...
            <FadeInFromTop>
                <div className=' w-full h-[70px] bg-white text-bg-blue-500 flex items-center justify-between px-[10px]'>
                    ...
                    <div className=" hidden lg:flex">
                        ...
                        <Link href={'/#nft'} className=" mb-4 w-fit bg-white text-blue-500 flex items-center justify-center hover:border-b-2 hover:border-blue-400 duration-500 mx-4">NFTs</Link>
                        ...
                        >
                            ...
                            >
                                ...
                                <ul style={{ listStyle: "none", padding: 0 }}>
                                    ...
                                    <Link onClick={toggleSidebar} href={'/#roadmap'} className=" p-3 mb-4 w-fit bg-white rounded-full text-blue-500 flex items-center justify-center hover:border-2 hover:border-blue-400 hover:bg-blue-400 hover:text-white duration-500 mx-4">Roadmap</Link>
                                    <Link onClick={toggleSidebar} href={'/#nft'} className=" p-3 mb-4 w-fit bg-white rounded-full text-blue-500 flex items-center justify-center hover:border-2 hover:border-blue-400 hover:bg-blue-400 hover:text-white duration-500 mx-4">NFTs</Link>
